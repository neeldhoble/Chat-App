...
import notify from '../assets/sound/notify.mp3'
      ...
      {selectedConversation === null ? (
        <div className='flex items-center justify-center w-full h-full'>
          <div className='px-4 text-center text-2xl text-gray-950 font-semibold flex flex-col items-center gap-2'>
            ...
            <p></p>
            <TiMessages className='text-6xl text-gray-950 text-center' />
          </div>
        </div>
      ) : (
        <>
          <div className='flex justify-between gap-1 bg-sky-600 md:px-2 rounded-lg h-10 md:h-12'>
            <div className='flex gap-2 md:justify-between items-center w-full'>
              <div className='md:hidden ml-1 self-center'>
                <button onClick={() => onBackUser(true)} className='bg-white text-black rounded-full self-center px-2 py-1'>
              ...
              <div className='flex justify-between mr-2 gap-2'>
                <div className='self-center '>
                  <img className='rounded-full w-6 h-6 md:w-10 md:h-10 cursor-pointer' src={selectedConversation.profile} />
                </div>
          ...
          <div className='flex-1 overflow-auto'>
            ...
            {!loading && messages?.length === 0 && (
              <p className='text-center text-white items-center'>Say hii to your New Friend</p>
            )}
          ...
          <form onSubmit={handleSubmit} className='rounded-full text-black'>
            <div className='w-full rounded-full flex items-center bg-white'>
              <input type="text" value={sendData || ""} onChange={handleMessage} required id='message' className='w-full bg-transparent outline-none px-4 rounded-full' />
              <button type='submit'>
